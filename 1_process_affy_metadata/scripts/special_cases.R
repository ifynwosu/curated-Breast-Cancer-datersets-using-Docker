...
if (gseID == "GSE20437") {
  #remove histology...change contro to red mamo.. change mamo to NA...chanege er bc to just er
  metadata <- metadata %>%
...
if (gseID == "GSE76275") {
  metadata <- metadata %>%
    dplyr::select(-c("title", "characteristics_18", "description", "data_processing_1", "tissue", "set", "tnbc_subtype"))
}
