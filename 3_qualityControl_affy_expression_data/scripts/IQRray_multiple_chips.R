...
write_tsv(big_IQR_file_U133A, paste0(out_file_path, "U133_A_extra.tsv"))
print("Saved to U133_A_extra.tsv")
...
write_tsv(big_IQR_file_U133B, paste0(out_file_path, "U133_B.tsv"))
...
write_tsv(final_score_GSE6532_U133_Plus2, paste0(out_file_path, "U133_Plus2_extra.tsv"))
