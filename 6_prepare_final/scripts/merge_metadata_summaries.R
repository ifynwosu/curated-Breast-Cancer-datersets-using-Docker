...
NCIT_term_values_sum_multiple <- NCIT_term_values_multiple |> 
  group_by(NCIT_Term_values_01, NCIT_Term_values_02, NCIT_Term_values_03, NCIT_Term_values_04, NCIT_Term_values_05, NCIT_Term_values_06, NCIT_Term_values_07, NCIT_Term_values_08, NCIT_Term_values_09, NCIT_Term_values_10, NCIT_Term_values_11, NCIT_Term_values_12, NCIT_Term_values_13, NCIT_Term_values_14, NCIT_Term_values_15, NCIT_Term_values_16, NCIT_Term_values_17, NCIT_Term_values_18, NCIT_Term_values_19) |>
  tally()  |> 
  arrange(desc(n))
