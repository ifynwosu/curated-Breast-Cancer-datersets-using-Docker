file_paths <- list.files(IQRray_filtered, full.names = T)

special_cases <- c("GSE62944_TCGA_Tumor.tsv", "GSE62944_TCGA_Normal.tsv", "GSE81538_MSCANBI_Cohort405_HiSeq.tsv", "GSE96058_MSCANBI_Cohort3273_HiSeq.tsv",
                   "GSE96058_MSCANBI_Cohort3273_NextSeq.tsv", "ICGC_BRCA_FR.tsv", "ICGC_BRCA_KR.tsv", "METABRIC.tsv")
