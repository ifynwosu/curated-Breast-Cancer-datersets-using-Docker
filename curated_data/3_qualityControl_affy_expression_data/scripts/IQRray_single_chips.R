...
for (gseID in huGene$gseID) {
  ...
  complete_scores <- bind_file(IQRay_file, final_score)
}
write_tsv(complete_scores, paste0(out_file_path, "huGene.tsv"))
...
write_tsv(complete_scores, paste0(out_file_path, "huExon.tsv"))
...
write_tsv(complete_scores, paste0(out_file_path, "U95_2.tsv"))
...
write_tsv(complete_scores, paste0(out_file_path, "U133A_Early_Access.tsv"))
...
write_tsv(complete_scores, paste0(out_file_path, "U133_A.tsv"))
...
write_tsv(complete_scores, paste0(out_file_path, "U133_A2.tsv"))
...
write_tsv(complete_scores, paste0(out_file_path, "U133_Plus2.tsv"))
print("Saved to U133_Plus2.tsv")
